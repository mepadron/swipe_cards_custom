...
class DraggableCard extends StatefulWidget {
  ...
  DraggableCard({this.card, this.likeTag, this.nopeTag, this.superLikeTag, this.isDraggable = true, this.onSlideUpdate, this.onSlideOutComplete, this.slideTo, this.onSlideRegionUpdate, this.upSwipeAllowed = false, this.leftSwipeAllowed = true, this.rightSwipeAllowed = true, this.isBackCard = false, this.padding = EdgeInsets.zero});
...
class _DraggableCardState extends State<DraggableCard> with TickerProviderStateMixin {
  ...
  void _onPanUpdate(DragUpdateDetails details) {
    ...
    final isInLeftRegion = (cardOffset!.dx / context.size!.width) < -0.18;
